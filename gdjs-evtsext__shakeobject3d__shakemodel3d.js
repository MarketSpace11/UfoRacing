...
{for(var i = 0, len = gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.ShakeContext.GDObjectObjects1.length ;i < len;++i) {
    ...
    gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.ShakeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setDuration(eventsFunctionContext.getArgument("Duration"));
}
}{for(var i = 0, len = gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.ShakeContext.GDObjectObjects1.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = ((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("Duration")) || 0 : 0) < eventsFunctionContext.getArgument("StartEaseDuration") + eventsFunctionContext.getArgument("StopEaseDuration"));
}
if (isConditionTrue_0) {
gdjs.copyArray(eventsFunctionContext.getObjects("Object"), gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.ShakeContext.GDObjectObjects1);
{for(var i = 0, len = gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.ShakeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.ShakeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setStartEasingDuration(eventsFunctionContext.getArgument("StartEaseDuration") * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__CameraShake").getChild("Duration")) / (eventsFunctionContext.getArgument("StartEaseDuration") + eventsFunctionContext.getArgument("StopEaseDuration")));
}
}{for(var i = 0, len = gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.ShakeContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__ShakeObject3D__ShakeModel3D.ShakeModel3D.prototype.ShakeContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._setStopEasingDuration(eventsFunctionContext.getArgument("StopEaseDuration") * gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__CameraShake").getChild("Duration")) / (eventsFunctionContext.getArgument("StartEaseDuration") + eventsFunctionContext.getArgument("StopEaseDuration")));
}
}}
